...
function sessionIsAdmin(session: any) {
    ...
    // ✅ accetta: flag session, ruolo DB, oppure allowlist env
    return flag || role === "ADMIN" || isAdminEmail(email);
}
...
export async function POST(req: Request) {
    ...
    // ✅ split create vs update (così puoi tornare inserted/updated reali)
    const CHUNK = 800;
